...
import 'package:lms_app/helper_elearning/widget/my_field_validator.dart';
...
class MyFormValidator {
  ...
  bool ?consumeError;
  MyFormValidator({this.errors, this.consumeError, this.formKey, this.remainingError}){
    errors ??= {};
    remainingError ??= {};
    formKey ??= GlobalKey();
    consumeError ??= true;
