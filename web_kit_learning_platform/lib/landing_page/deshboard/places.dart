                              ...
                              child: Padding(padding: const EdgeInsets.all(10),
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 10,),
                                    Text(time[index],style: baseStyle.copyWith(fontSize: 12,color: notifier.subgreycolor)),
                                  ],
                                ),
                              ),
                            )
                              ...
                              child: Padding(padding: const EdgeInsets.all(10),
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 10,),
                                    Text(time2[index],style: baseStyle.copyWith(fontSize: 12,color: notifier.subgreycolor)),
                                  ],
                                ),
                              ),
                            ),
