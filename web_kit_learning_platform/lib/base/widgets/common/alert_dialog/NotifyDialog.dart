...
class NotifyDialog {
  ...
  {
    String titleStr = (keyTitle!=null&& keyTitle.isNotEmpty)?L10nX.of().getStringByKey(keyTitle):"";
    String description = (descriptionKey!=null&& descriptionKey.isNotEmpty)?L10nX.of().getStringByKey(descriptionKey):"";
    String buttonText = (buttonTextKey!=null&& buttonTextKey.isNotEmpty)?L10nX.of().getStringByKey(buttonTextKey):"";
