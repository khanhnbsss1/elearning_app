  ...
  static Widget _getIcon(FlashBarType? toastType) {
    if (toastType == null || toastType == FlashBarType.NORMAL) {
      return SvgPicture.asset(
          ImageManager().getSvgImagePath(ImageManager.ic_success));
    } else if (toastType == FlashBarType.ERROR) {
      return SvgPicture.asset(ImageManager().getSvgImagePath(ImageManager.ic_ban));
    }
    return SvgPicture.asset(ImageManager().getSvgImagePath(ImageManager.ic_success));
  }
