                        ...
                        children: [
                          Center(
                            child: MyText.titleLarge(
                              L10nX.getStr.reset_password.capitalizeWords,
                              fontWeight: 700,
                            ),
                          ),
                          MySpacing.height(10),
                          Center(
                            child: MyText.bodySmall(
                              L10nX.getStr.your_password_will_be_reset,
                              muted: true,
                            ),
                          ),
                          MySpacing.height(45),
                          MyText.labelMedium(L10nX.getStr.password),
                          MySpacing.height(4),
                          TextFormField(
                          ...
                          MySpacing.height(15),
                          MyText.labelMedium(
                              L10nX.getStr.confirm_password.capitalizeWords),
                          MySpacing.height(4),
                          TextFormField(
                            validator: controller.basicValidator
