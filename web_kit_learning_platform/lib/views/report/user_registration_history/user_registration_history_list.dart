                ...
                children: [
                  ...
                  Visibility(
                    ...
                    child: ActionButton1(
                      ...
                      onTap: () {
                        BlocProvider.of<UserRegistrationHistoryListBloc>(context).add(UserRegistrationHistoryListOnSearchByFilterEvent(searchCommonRequest: state.searchCommonRequest!.copyWith(keyword: textEditingController.text)));
                      },
                    ),
                  ),
                  Visibility(
