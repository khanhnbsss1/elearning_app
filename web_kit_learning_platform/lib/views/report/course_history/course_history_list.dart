                ...
                children: [
                  ...
                  Visibility(
                    ...
                    child: ActionButton1(
                      ...
                      onTap: () {
                        BlocProvider.of<CourseHistoryListBloc>(context).add(CourseHistoryListOnSearchByFilterEvent(searchCommonRequest: state.searchCommonRequest!.copyWith(keyword: textEditingController.text)));
                      },
                    ),
                  ),
                  Visibility(
