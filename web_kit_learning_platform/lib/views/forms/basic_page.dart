      ...
      child: GetBuilder(
        ...
        builder: (controller) {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium(
                  L10nX.getStr.basic_forms.capitalizeWords,
                      fontSize: 18,
                      fontWeight: 600,
                    ),
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: L10nX.getStr.Basic, active: true),
                      ],
                    ),
                  ],
                ),
                              ...
                              child: MyContainer(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    MySpacing.width(12),
                                    MyText.titleMedium(
                                    L10nX.getStr.basic_input.capitalizeWords,
                                      fontWeight: 600,
                                    ),
                                  ],
                                ),
          ...
          L10nX.getStr.password,
                                  ...
                                  Row(
                                    children: [
                                      MyText.labelLarge(L10nX.getStr.gender),
                                      MySpacing.width(16),
                                      Expanded(
                                        child: Wrap(
                                            spacing: 16,
                                  ...
                                  MySpacing.height(20),
                                  MyText.labelLarge(
          L10nX.getStr.other_settings.capitalizeWords),
                                  MySpacing.height(4),
                                  SwitchListTile(
                                      ...
                                      L10nX.getStr.set_profile_to_private)),
                                  SwitchListTile(
                                      activeColor: contentTheme.primary,
                          ...
                          children: [
                              ...
                              child: MyContainer(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    MySpacing.width(12),
                                    MyText.titleMedium(
                                    L10nX.getStr.more_inputs.capitalizeWords,
                                      fontWeight: 600,
                                    ),
                                  ],
                                ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  MyText.labelLarge(
                                  L10nX.getStr.date_time_pickers.capitalizeWords),
                                  MySpacing.height(12),
                                  Wrap(
                                    spacing: 16,
                                    runSpacing: 16,
                                  ...
                                  MySpacing.height(20),
                                  MyText.labelLarge(L10nX.getStr.sliders),
                                  MySpacing.height(8),
                                  Slider(
                                    activeColor: contentTheme.primary,
                                    inactiveColor:
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(
                                          width: 180,
                                          child:
                                              MyText.labelLarge(L10nX.getStr.filled)),
                                      Switch(
                                        onChanged:
                                  ...
                                  MySpacing.height(20),
                                  MyText.labelLarge(L10nX.getStr.output),
                                  MySpacing.height(20),
                                  TextFormField(
                                    decoration: InputDecoration(
