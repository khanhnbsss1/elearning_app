...
class SearchQuizDropDown extends StatefulWidget {
  ...
  SearchQuizDropDown({required this.allWords, required this.onAddWords, required this.onRemoveWords, this.exitsQuestion});
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text("${questionInfo.weightage}đ    ${questionInfo.typeQuestion}"),
                            Gap(Dimens.size8),
                            InkWell(
                              onTap: () {
