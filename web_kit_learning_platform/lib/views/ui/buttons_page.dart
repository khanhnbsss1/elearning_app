      ...
      child: Wrap(
        ...
        children: [
          ...
          MyButton(
            ...
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(L10nX.getStr.warning,
              color: contentTheme.warning,
            ),
          ),
          MyButton(
      ...
      child: Wrap(
        ...
        children: [
          ...
          MyButton(
            ...
            backgroundColor: contentTheme.danger,
            borderRadiusAll: 20,
            child: MyText.bodySmall(L10nX.getStr.danger,
              color: contentTheme.onDanger,
            ),
          ),
        ],
      ...
      child: Wrap(
        ...
        children: [
          MyButton.outlined(
            ...
            splashColor: contentTheme.primary.withOpacity(0.1),
            borderRadiusAll: 20,
            child: MyText.bodySmall(L10nX.getStr.primary,
              color: contentTheme.primary,
            ),
          ),
          MyButton.outlined(
            ...
            splashColor: contentTheme.secondary.withOpacity(0.1),
            borderRadiusAll: 20,
            child: MyText.bodySmall(L10nX.getStr.secondary,
              color: contentTheme.secondary,
            ),
          ),
          MyButton.outlined(
            ...
            splashColor: contentTheme.success.withOpacity(0.1),
            borderRadiusAll: 20,
            child: MyText.bodySmall(L10nX.getStr.success,
              color: contentTheme.success,
            ),
          ),
          MyButton.outlined(
          ...
          MyButton.outlined(
            ...
            splashColor: contentTheme.info.withOpacity(0.1),
            borderRadiusAll: 20,
            child: MyText.bodySmall(L10nX.getStr.info,
              color: contentTheme.info,
            ),
          ),
          MyButton.outlined(
      ...
      child: Wrap(
        ...
        children: [
          MyButton(
            ...
            backgroundColor: contentTheme.primary,
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.labelSmall(L10nX.getStr.small,
              color: contentTheme.onPrimary,
            ),
          ),
          MyButton(
            ...
            backgroundColor: contentTheme.primary,
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(L10nX.getStr.medium,
              color: contentTheme.onPrimary,
            ),
          ),
          MyButton(
            ...
            backgroundColor: contentTheme.primary,
            borderRadiusAll: AppStyle.buttonRadius.medium,
            child: MyText.bodySmall(L10nX.getStr.large,
              color: contentTheme.onPrimary,
            ),
          ),
        ],
