...
class ExampleFrom extends StatefulWidget{
  ...
  ExampleFrom({this.sentenceInfo, this.onRemoveSentenceInfo, this.onSaveSentenceInfo});
  @override
...
class ExampleFromState extends State<ExampleFrom>  with UIMixin{  
  ...
  Widget build(BuildContext context) {
    ...
    enaAbleSaveSentenceInfo = 
        (chineseSentenceController.text??"").isNotEmpty && 
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon:  (widget.sentenceInfo?.audioFileInfo?.link??"").isNotEmpty
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                (audioSentenceController.text == "") ? SizedBox() : IconButton(
                                    onPressed: () {
                                      setState(() {
