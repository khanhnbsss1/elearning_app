        ...
        builder: (BuildContext context) {
          return Dialog(
            child: SizedBox(
              ...
              height: MediaQuery.of(context).size.height*(ResponsiveInfo.isTablet()?0.7:0.5),
              child: this
            ),
            );
        });
  }
  AddWords({this.vocabularyInfo});
...
class _AddWordsState extends State<AddWords>
  ...
  void initState() {
    super.initState();
    exampleTextControllers.add(new TextEditingController());
    exampleMeaningControllers.add(new TextEditingController());
    exampleSimplifiedControllers.add(new TextEditingController());
    exampleSoundControllers.add(new TextEditingController());
    savedExample.add(false);
    addWordController = Get.put(AddWordController(vocabularyInfo: widget.vocabularyInfo));
  }
