            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium(
                      L10nX.getStr.syncfusion_charts.capitalizeWords,
                      fontSize: 18,
                      fontWeight: 600,
                    ),
                    MyBreadcrumb(
                      children: [
                        MyBreadcrumbItem(name: L10nX.getStr.ui),
                        MyBreadcrumbItem(name: L10nX.getStr.charts, active: true),
                      ],
                    ),
                  ],
                ),
                        ...
                        child: MyContainer(
                          child: Column(
                            children: [
                              ...
                              SfPyramidChart(
                                title: ChartTitle(
                                    text: L10nX.getStr.comparison_of_calories,
