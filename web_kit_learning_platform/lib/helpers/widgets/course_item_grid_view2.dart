...
class CourseItemGridView2 extends StatelessWidget {
  CourseItemGridView2({
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: MediaQuery.of(context).size.width * (ResponsiveInfo.isPhone()?1:1/4.3),
                ...
                child: Column(
                  children: [
                    ...
                    // borderRadius: BorderRadius.only(topLeft: Radius.circular(12), topRight: Radius.circular(12)),
                      borderRadius: BorderRadius.circular((!isHovered) ? 16.0 : 0),
                    child: Image.network(
                        courseInfo.image!,
                        fit: BoxFit.cover,
                    ...
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(right: 8.0, left: 8, bottom: 8, top: 8),
                        child: Container(
