                              ...
                              child: Padding(padding: const EdgeInsets.all(10),
                                child: Column(
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          alignment: Alignment.center,
                                          child: Text('1480',style: TextStyle(fontFamily: 'gilroysemi',fontSize: 12,color: notifier.subgreycolor,fontWeight: FontWeight.w800,letterSpacing: 1)),
                                        ),
                                      ],
                                    ),
                                    ...
                                    Text(placesname[index],style: TextStyle(fontFamily: 'gilroysemi',fontSize: 16,color: notifier.blackcolor)),
                                    const SizedBox(height: 10,),
                                    Text(time[index],style: TextStyle(fontFamily: 'gilroymed',fontSize: 12,color: notifier.subgreycolor)),
                                  ],
                                ),
                              ),
                            )
                              ...
                              child: Padding(padding: const EdgeInsets.all(10),
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 20,),
                                    Text(placesname2[index],style: TextStyle(fontFamily: 'gilroysemi',fontSize: 16,color: notifier.blackcolor)),
                                    const SizedBox(height: 10,),
                                    Text(time2[index],style: TextStyle(fontFamily: 'gilroymed',fontSize: 12,color: notifier.subgreycolor)),
                                  ],
                                ),
                              ),
                            ),
