              ...
              Visibility(
                ...
                child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: SizedBox(
                        width: Dimens.size30,
                          child:ImageManager().getPngImage(ImageManager.ic_back_png, width: Dimens.size20, height: Dimens.size20)
                    ),
                    )),
              ),
              Expanded(
              ...
              Visibility(
                ...
                child: Material(
                    ...
                    child: InkWell(
                      ...
                      child: SizedBox(
                        width: Dimens.size30,
                          child:ImageManager().getPngImage(ImageManager.ic_next_png, width: Dimens.size20, height: Dimens.size20)
                      ),
                    )),
              ),
              Gap(Dimens.size10),
