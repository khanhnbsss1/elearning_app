...
final courseFilterInfoProvider = StateProvider<CourseFilterInfo>(
    (ref) => CourseFilterInfo(name: "All"));
...
class _SearchCategoriesState extends ConsumerState<SearchCategories> {
  ...
  Widget build(BuildContext context) {
    ...
    final courseFilterInfo =
        ref.watch(courseFilterInfoProvider);
    final subFilterInfo =
        ref.watch(subFilterInfoProvider);
