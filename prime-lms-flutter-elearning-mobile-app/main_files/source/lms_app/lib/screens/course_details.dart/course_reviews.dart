...
final courseReviewProvider = FutureProvider.autoDispose.family<List<Review>, String>((ref, courseId) async {
  final List<Review> reviews = await ApiService().getLimitedReviews(courseId, 3);
  return reviews;
});
