...
class SearchCoursesViewV2 extends ConsumerStatefulWidget {
  SearchCoursesViewV2(
      {super.key, this.gradeId, this.categoryId, this.typePayment, this.mode, this.keyword, this.producerName});
  ...
  @override
  ConsumerState<SearchCoursesViewV2> createState() => _SearchCoursesViewState();
}

class _SearchCoursesViewState extends ConsumerState<SearchCoursesViewV2> {
