class ApiName {
  ...
  final String getFeaturedCourse = "/get-interest-courses";
  final String getAdvancedCourseList = "/advanced-filter-courses";
  ...
  final String getFilterCourse = "/anvanced-filter-directory";
